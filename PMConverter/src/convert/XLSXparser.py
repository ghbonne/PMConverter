...
class XLSXParser(FileParser):
    ...
    def from_schedule_object(self, project_object, file_path_output):
        ...
        note_cell = workbook.add_format({'font_size': 8, 'font_color': '#808080'})
        ...
        # write PMConverter version stamp:
        agenda_worksheet.write(27, 0, "Generated by PMConverter v{0}".format(__version__), note_cell)
